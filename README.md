...
| Неделя | Докладчик(и) | Тема доклада | Ссылка на материалы доклада |
| :---: | :---: | :---: | :---: |
| Неделя 1 | *докладов не будет* | | |
| Неделя 2 | | | |
| Неделя 3 | | | |
| Неделя 4 | | | |
| Неделя 5 | | | |
...
На знание базовых методолгий разработки, их сильных и слабых сторон
